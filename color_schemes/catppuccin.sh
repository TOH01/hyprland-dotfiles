...
export THEME_DUNST_OPACITY="0.92"
...
dunst_alpha_hex="$(opacity_to_hex "${THEME_DUNST_OPACITY}")"
...
export THEME_DUNST_SURFACE_HEX="${THEME_BG_HEX}${dunst_alpha_hex}"
export THEME_DUNST_SURFACE_RGBA="rgba(${bg_r}, ${bg_g}, ${bg_b}, ${THEME_DUNST_OPACITY})"
export THEME_DUNST_CRITICAL_BG_HEX="${THEME_DUNST_SURFACE_HEX}"
